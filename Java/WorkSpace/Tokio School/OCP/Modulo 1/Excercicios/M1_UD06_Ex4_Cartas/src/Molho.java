...
public class Molho {
    ...
    public void ordena() {
        ...
        if (algoritmo != null) {
            this.cartas = algoritmo.ordena(cartas);
        }
    }
    ...
    // Construtor que recebe lista de cartas,
    // usado principalmente para receber a lista de cartas ordenadas
    public Molho(List cartas) {
        this.cartas = cartas;
    }
     ...
     * @throws IllegalArgumentException Se a posicao nao e valida na lista
     */
     ...
     * @throws IllegalArgumentException Se a posicao nao for valida na lista
     */
