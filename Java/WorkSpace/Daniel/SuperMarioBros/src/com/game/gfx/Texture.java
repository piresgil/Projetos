...
public class Texture {
    // Constants
    private final String PARENT_FOLDER = "/img";
    ...
    public BufferedImage[] mario_l, mario_s, tile_1, tile_2, tile_3, tile_4, pipe_1, debris_1;
    ...
    public Texture() {
        ...
        try {
            ...
            enemy_sheet = loader.loadImage(PARENT_FOLDER + "/characters.gif");
            npc_sheet = loader.loadImage(PARENT_FOLDER + "/characters.gif");
            block_sheet = loader.loadImage(PARENT_FOLDER + "/blocks.png");
            tile_sheet = loader.loadImage(PARENT_FOLDER + "/tiles.png");
            game_over_sheet = loader.loadImage(PARENT_FOLDER + "/font.png");
            intro_sheet = loader.loadImage(PARENT_FOLDER + "/font.png");
