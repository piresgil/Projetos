    ...
    public static String aplicarBuffs(List<Personagem> herois, List<Personagem> bestas, int turno) {
        ...
        for (Personagem heroi : herois) {
            if (buffEscolhido == 1 && turno % 5 == 0) {  // A cada 5 turnos
                ...
                // System.out.println(heroi.getNome() + "Buff, sofreu " + dano + " de dano (Terramoto). ");
            }
            ...
            if (buffEscolhido == 2 && turno % 3 == 0) {  // A cada 3 turnos
                ...
                // System.out.println(heroi.getNome() + "Buff, ganhou " + dano + " de vida (Benção). ");
            }
            ...
            if (buffEscolhido == 3 && turno % 2 == 0) {  // A cada 2 turnos
                ...
                // System.out.println(heroi.getNome() + "Buff, ganhou " + dano + " de Armadura (Armadura). ");
            }
            ...
            if (buffEscolhido == 4) {  // todos turnos
                ...
                // System.out.println(heroi.getNome() + "Buff, sofreu " + dano + " de Armadura (Chuva). ");
            }
        }
        ...
        for (Personagem besta : bestas) {
            ...
            if (buffEscolhido == 2 && turno % 3 == 0) {  // A cada 3 turnos
                ...
                //  System.out.println(besta.getNome() + "Buff, ganhou " + dano + " de vida (Benção). ");
            }
            ...
            if (buffEscolhido == 3 && turno % 2 == 0) {  // A cada 2 turnos
                ...
                // System.out.println(besta.getNome() + "Buff, ganhou " + dano + " de Armadura (Proteção). ");
            }
            ...
            if (buffEscolhido == 4) {  // todos turnos
                ...
                //System.out.println(besta.getNome() + "Buff, sofreu " + dano + " de Armadura (Chuva acida). ");
            }
        }
        ...
        if (buffEscolhido == 2 && turno % 3 == 0) {
            resultado += "Buff, ganham " + dano + " de Vida. (Benção)";
        }

        if (buffEscolhido == 3 && turno % 2 == 0) {
            resultado += "Buff, ganham " + dano + " de Armadura. (Proteção)";
        }

        if (buffEscolhido == 4) {
            resultado += "Buff, sofrem " + dano + " de Armadura. (Chuva Ácida)";
        }
